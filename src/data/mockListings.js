...
<li>Opcja: skipper (+200 zł/dzień)</li>
  ...
  {
    id: 13,
    title: 'Festiwal Smaków Mazurskich',
    category: 'wydarzenia',
    city: 'Mrągowo',
    address: 'Rynek Główny, Mrągowo',
    lat: 53.8686, lng: 21.3063,
    date: '2026-07-05', time: '12:00',
    price: 0, priceLabel: 'Bezpłatne',
    description: '<p>Festiwal lokalnej kuchni mazurskiej z pokazami gotowania, degustacjami i warsztatami dla dzieci.</p>',
    image: 'https://picsum.photos/seed/festiwal-smakow/800/450',
    rating: 4.6, isNew: true,
    tags: ['festiwal', 'jedzenie', 'rodzina'],
  },
  {
    id: 14,
    title: 'Apartamenty Mazurska Przystań',
    category: 'noclegi',
    city: 'Mikołajki',
    address: 'ul. Leśna 8, Mikołajki',
    lat: 53.7965, lng: 21.5812,
    date: null, time: null,
    price: 380, priceLabel: 'od 380 zł / noc',
    description: '<p>Nowoczesne apartamenty w centrum Mikołajek, 5 minut pieszo od jeziora. Sauna, taras, miejsce parkingowe.</p>',
    image: 'https://picsum.photos/seed/apartamenty-mikolajki/800/450',
    rating: 4.7, isNew: false,
    tags: ['apartament', 'sauna', 'centrum'],
  },
  {
    id: 15,
    title: 'Kajaki na Krutyni — wynajem i spływy',
    category: 'czartery',
    city: 'Ruciane-Nida',
    address: 'Przystań Krutynia, Ruciane-Nida',
    lat: 53.6401, lng: 21.5217,
    date: null, time: null,
    price: 60, priceLabel: 'od 60 zł / dzień',
    description: '<p>Spływy kajakowe trasą Krutyni — jednej z najpiękniejszych rzek Mazur. Wynajem kajaków 1 i 2-osobowych, transport na start.</p>',
    image: 'https://picsum.photos/seed/kajaki-krutynia/800/450',
    rating: 4.9, isNew: true,
    tags: ['kajak', 'Krutynia', 'spływ', 'rzeka'],
  },
  {
    id: 16,
    title: 'Restauracja Mazurska Chata',
    category: 'restauracje',
    city: 'Pisz',
    address: 'ul. Rybacka 3, Pisz',
    lat: 53.6277, lng: 21.8197,
    date: null, time: null,
    price: 0, priceLabel: 'Menu od 25 zł',
    description: '<p>Tradycyjna kuchnia mazurska w klimatycznej chacie nad jeziorem. Ryby z lokalnych połowów, zupy, pierogi z serem i ziemniakami.</p>',
    image: 'https://picsum.photos/seed/chata-mazurska/800/450',
    rating: 4.5, isNew: false,
    tags: ['ryby', 'tradycja', 'jezioro'],
  },
  {
    id: 17,
    title: 'Kemping Leśna Polana nad Jeziorem Tałty',
    category: 'kempingi',
    city: 'Mikołajki',
    address: 'Tałty 12, k. Mikołajek',
    lat: 53.8102, lng: 21.6044,
    date: null, time: null,
    price: 45, priceLabel: 'od 45 zł / os./noc',
    description: '<p>Kemping w sosnowym lesie przy jeziorze Tałty. Miejsca namiotowe i dla kamperów, sanitariaty, plac zabaw, wypożyczalnia rowerów.</p>',
    image: 'https://picsum.photos/seed/kemping-talty/800/450',
    rating: 4.4, isNew: false,
    tags: ['namiot', 'kamper', 'las', 'Tałty'],
  },
  {
    id: 18,
    title: 'Koncert Mazurskie Lato — Varius Manx',
    category: 'koncerty',
    city: 'Giżycko',
    address: 'Amfiteatr Giżycko',
    lat: 54.0421, lng: 21.7698,
    date: '2026-07-19', time: '20:00',
    price: 89, priceLabel: '89 zł',
    description: '<p>Letni koncert Varius Manx w plenerowym amfiteatrze w Giżycku. Letnie hity przy mazurskich jeziorach — niezapomniana atmosfera.</p>',
    image: 'https://picsum.photos/seed/koncert-gizycko/800/450',
    rating: 4.8, isNew: true,
    tags: ['koncert', 'plener', 'muzyka', 'lato'],
  },
  {
    id: 19,
    title: 'Park Linowy Mazury Adventure',
    category: 'atrakcje',
    city: 'Węgorzewo',
    address: 'ul. Leśna 22, Węgorzewo',
    lat: 54.2201, lng: 21.7388,
    date: null, time: null,
    price: 55, priceLabel: 'od 55 zł',
    description: '<p>Park linowy z 8 trasami o różnym stopniu trudności, ziplinem 250m, ścianką wspinaczkową i strefą dla dzieci 3+.</p>',
    image: 'https://picsum.photos/seed/park-linowy/800/450',
    rating: 4.6, isNew: false,
    tags: ['park linowy', 'adrenalina', 'dzieci', 'zipline'],
  },
  {
    id: 20,
    title: 'Rejs statkiem po Wielkich Jeziorach Mazurskich',
    category: 'czartery',
    city: 'Giżycko',
    address: 'Przystań Giżycko, ul. Portowa 1',
    lat: 54.0355, lng: 21.7555,
    date: null, time: null,
    price: 120, priceLabel: 'od 120 zł / os.',
    description: '<p>Rejs statkiem pasażerskim po szlaku Wielkich Jezior Mazurskich. Trasa: Giżycko–Mikołajki–Giżycko, 6 godzin na wodzie z komentarzem przewodnika.</p>',
    image: 'https://picsum.photos/seed/rejs-statkiem/800/450',
    rating: 4.75, isNew: true,
    tags: ['rejs', 'statek', 'jezioro', 'wycieczka'],
  },
  {
    id: 21,
    title: 'Ośrodek Wypoczynkowy Słoneczna Zatoka',
    category: 'noclegi',
    city: 'Ruciane-Nida',
    address: 'ul. Nadjeziorna 5, Ruciane-Nida',
    lat: 53.6489, lng: 21.5301,
    date: null, time: null,
    price: 220, priceLabel: 'od 220 zł / noc',
    description: '<p>Ośrodek wypoczynkowy bezpośrednio nad jeziorem Nidzkim. Domki 4- i 6-osobowe, plażowisko, kajaki w cenie, grill, siatkówka plażowa.</p>',
    image: 'https://picsum.photos/seed/sloneczna-zatoka/800/450',
    rating: 4.5, isNew: false,
    tags: ['domki', 'plaża', 'kajaki', 'Nidzkie'],
  },
  {
    id: 22,
    title: 'Maraton Mazurski 2026',
    category: 'wydarzenia',
    city: 'Mrągowo',
    address: 'Stadion Miejski, Mrągowo',
    lat: 53.8711, lng: 21.3022,
    date: '2026-08-16', time: '09:00',
    price: 120, priceLabel: '120 zł',
    description: '<p>Bieg maratoński i półmaratoński malowniczą trasą wokół jezior mazurskich. Zapisy online, pakiet startowy w cenie, medale dla wszystkich finisherów.</p>',
    image: 'https://picsum.photos/seed/maraton-mazurski/800/450',
    rating: 4.7, isNew: true,
    tags: ['bieg', 'maraton', 'sport', 'lato'],
  },
];
